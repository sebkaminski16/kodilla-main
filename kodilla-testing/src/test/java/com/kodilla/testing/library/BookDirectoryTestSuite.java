...
class BookDirectoryTestSuite {
    ...
    private LibraryUser fakeLibraryUser = new LibraryUser("Jan", "Kowalski", "123456789101");
    ...
    void testListBooksInHandsOf0() {
        ...
        // When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(fakeLibraryUser);
        // Then
    ...
    void testListBooksInHandsOf1() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(fakeLibraryUser)).thenReturn(resultListOfBooks);
        // When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(fakeLibraryUser);
        // Then
