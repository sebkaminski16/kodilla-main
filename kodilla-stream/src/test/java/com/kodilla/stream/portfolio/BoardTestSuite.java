...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        var average = project.getTaskLists().stream()
                ...
                .mapToInt(i -> Math.toIntExact(i)).average().getAsDouble();

        /*Porownywanie dwoch dat za pomoca "ChronoUnit":
        https://stackoverflow.com/questions/27005861/calculate-days-between-two-dates-in-java-8

        Konwertowanie Stream na IntStream (zeby skorzystac z metody "average"):
        https://stackoverflow.com/a/28015866/14819876
         */
